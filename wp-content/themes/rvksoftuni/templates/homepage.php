    ...
    <div class="wrapper">
        ...
        <div class="banner" style="background-image: url(<?php echo the_field('page_banner_background_image'); ?>); ">
            <div class="overlay">
                ...
                <!-- Initial option but then used WP_query(); above -->
                <!-- <div class="service row text-center  wowload fadeInDownBig">
        ...
        <div class="mx-auto text-center spacer">
            <button id="ajax-request" class="btn" style="background-color:rgba(159, 16, 64, 0.856); color:white;">AJAX Request Click me to read a message</button>
        ...
        <div id="about" class="about">
            <div class="row">
                <div class="col-sm-7 wowload fadeInLeft">
                    <div id="carousel-about" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="item active"><img src="<?php echo get_stylesheet_directory_uri() . '/images/portfolio/1.jpg' ?>" class="img-responsive"></div>
                            <div class="item"><img src="<?php echo get_stylesheet_directory_uri() . '/images/portfolio/2.jpg' ?>" class="img-responsive"></div>
                            <div class="item"><img src="<?php echo get_stylesheet_directory_uri() . '/images/portfolio/3.jpg' ?>" class="img-responsive"></div>
                        </div>
                        <!-- Controls -->
                ...
                <div class="col-sm-5 wowload fadeInRight">
                    <div class="spacer">
                        <h2><i class="fa fa-flask"></i> About monkey digital</h2>
